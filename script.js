/* --- DATA SOURCE --- */
// Using real Unsplash IDs for premium look
const products = [
  {
    id: 1,
...
function toggleMobileMenu() {
  const nav = document.getElementById("nav-links"); // This matches the ID in HTML
  ...
  if (nav.classList.contains("active")) {
    ...
    icon.style.color = "#ffffff"; // Turn X white
  } else {
    icon.classList.remove("fa-times");
    icon.classList.add("fa-bars");
    icon.style.color = "#333333"; // Turn Bars dark
  }
}
